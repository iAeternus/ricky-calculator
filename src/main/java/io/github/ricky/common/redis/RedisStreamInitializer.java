...
public class RedisStreamInitializer {
    ...
    private void ensureConsumerGroupsExist() {
        ...
        tryCreateConsumerGroup(operations, redisProperties.getDomainEventStream(), RcConstants.REDIS_DOMAIN_EVENT_CONSUMER_GROUP);
        tryCreateConsumerGroup(operations, redisProperties.getWebhookStream(), RcConstants.REDIS_WEBHOOK_CONSUMER_GROUP);
        tryCreateConsumerGroup(operations, redisProperties.getNotificationStream(), RcConstants.REDIS_NOTIFICATION_CONSUMER_GROUP);
    }
